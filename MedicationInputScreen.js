...
import { scheduleRefillReminder } from './services/complianceService';
...
export default function MedicationInputScreen({ navigation }) {
  ...
  const saveMedication = async () => {
    if (!medicationName || !dosage || !selectedFrequency || !prescriberEmail || !patientName || !refillDate) {
    ...
    try {
      ...
      try {
        ...
        scheduleRefillReminder(newMedication);
    ...
    <ScrollView style={styles.container}>
      <View style={styles.formContainer}>
        ...
        <View style={styles.inputGroup}>
          ...
          <TouchableOpacity onPress={() => setShowRefillDatePicker(true)} style={styles.dateInput}>
            <Text style={styles.dateText}>{refillDate ? refillDate.toLocaleDateString() : 'Select refill date'}</Text>
          </TouchableOpacity>
